...
public class DNI implements Verificable {
    ...
    public void verificar() throws CaracterIncorrecto, NumeroIncorrecto {
        ...
        try {
            ...
            throw new NumeroIncorrecto("El numero de Identificadores.DNI no tiene el formato adecuado");
        }

        if(numero.length() != 8) {
            throw new NumeroIncorrecto("Longitud de Identificadores.DNI incorrecta");
        }
